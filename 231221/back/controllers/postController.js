...
exports.getPostsTotal = async (req, res) => {
  try {
    const totalPosts = await Post.countDocuments();
...
// 게시글 작성
exports.getPostsWrite = async (req, res) => {
...
// 게시글 읽기
exports.getPostsRead = async (req, res) => {
...
// 게시글 삭제
exports.getPostsDelete = async (req, res) => {
  const postId = req.params.id;
  try {
...
// 게시글 수정
exports.getPostsUpdate = async (req, res) => {
